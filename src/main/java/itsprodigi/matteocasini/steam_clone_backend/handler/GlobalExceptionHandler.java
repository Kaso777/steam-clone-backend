...
public class GlobalExceptionHandler {
        ...
        // Gestisce UUID non validi (es. stringhe malformate)
        ...
        // Gestisce le eccezioni di validazione (@Valid sui DTO in ingresso) (status
        // 400)
        ...
        public ResponseEntity<ErrorResponseDTO> handleGlobalException(
                ...
                ErrorResponseDTO errorResponse = new ErrorResponseDTO(
                                ...
                                request.getDescription(false).replace("uri=", ""));
                // Potresti voler loggare 'ex' qui per scopi di debug, ma non esporre troppi
                // dettagli al client
